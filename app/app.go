...
import (
	...
	appparams "github.com/mconcat/module-plugin/app/params"
	"github.com/mconcat/module-plugin/x/moduleplugin"
	modulepluginkeeper "github.com/mconcat/module-plugin/x/moduleplugin/keeper"
	moduleplugintypes "github.com/mconcat/module-plugin/x/moduleplugin/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/moduleplugind")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	modulepluginKeeper modulepluginkeeper.Keeper
...
func New(
	...
	app.modulepluginKeeper = *modulepluginkeeper.NewKeeper(
        appCodec, keys[moduleplugintypes.StoreKey], keys[moduleplugintypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		moduleplugin.NewAppModule(appCodec, app.modulepluginKeeper),
